                                ...
                                <div class="ml-5 d-flex">
                                    <div>
                                        ...
                                        @elseif($tarefa->evento == 'stop')
                                            <button class="btn btn-success">Pausada</button>
                                        @else
                                            <button class="btn btn-danger">Não iniciado</button>
                                        @endif
                                    </div>
                                    <div class="ml-3">
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#alocados"><i class="fas fa-users"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
