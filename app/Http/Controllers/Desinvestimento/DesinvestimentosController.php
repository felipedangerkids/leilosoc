...
namespace App\Http\Controllers\Desinvestimento;

use App\Models\User;
use Illuminate\Http\Request;
use App\Models\Desinvestimento;
use App\Http\Controllers\Controller;

class DesinvestimentosController extends Controller
{
    /**
    ...
    {
        $save = Desinvestimento::create($request->all());
